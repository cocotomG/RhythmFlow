<template>
	<el-breadcrumb separator="/">
	 ...
	 <el-table border class="table" :data="info.songArr" @selection-change="handleSelectionChange">
		...
		<el-table-column label="歌曲图片" min-width="100">
	 ...
	 <el-pagination background layout="prev, pager, next" :total="pager.total" v-if="pager.total > 0" style="z-index: 100"
...
<script setup lang="ts">
	...
	const {dialog,song,rules,singerId} = toRefs(info);
